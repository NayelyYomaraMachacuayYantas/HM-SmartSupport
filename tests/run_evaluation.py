...
CASES = [
    ("CP01", "Consulta simple", ["¿Qué es una remalladora y para qué sirve?"], "Respuesta pertinente al dominio", None, None),
    ("CP02", "Consulta de mantenimiento", ["¿Qué mantenimiento necesita una remalladora?"], "Orientación clara", "mantenimiento", None),
    ("CP03", "Consulta de configuración", ["¿Cómo enhebro una máquina de coser recta?"], "Pasos comprensibles", "configuracion", None),
    ("CP04", "Pregunta ambigua", ["No funciona"], "Solicita aclaración", None, None),
    ("CP05", "Información desconocida", ["¿Cuál es el precio y stock exacto del modelo XZ-9000 Turbo?"], "No inventa información", None, None),
    ...
    ("CP07", "Conversación con seguimiento",
     ["¿Qué mantenimiento necesita una remalladora?", "¿Y cada cuánto tiempo debo hacerlo?"], "Mantiene contexto", None, None),
    ...
    ("CP10", "Audio -> chatbot", ["AUDIO:caso10"], "Transcribe y responde", None, None),
